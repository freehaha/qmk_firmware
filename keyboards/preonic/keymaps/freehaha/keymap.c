...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EXT] = LAYOUT_preonic_grid( /* extension */
      ...
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), KC_ESC,     KC_HOME, KC_END,  _______,
  ...
  [_EXTR] = LAYOUT_preonic_grid( /* extension */
      ...
      _______,  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_ESC,  KC_PGUP, KC_PGDN, PASTE,
      _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),
  ...
  [_FN] = LAYOUT_preonic_grid( /* FUNCTION */
		  ...
		  _______,   _______, _______,    _______, _______, _______, KC_HOME, KC_PGUP, KC_UP,   KC_PGDN,  _______, KC_SLCK, \
		  TG(_GAME), _______, _______,    _______, _______, _______, KC_END,  KC_LEFT, KC_DOWN, KC_RIGHT, KC_INS,  KC_PAUSE, \
		  _______,   _______, _______,    _______, _______, _______, _______, _______, _______, _______,  _______, _______ \
		  ),
